...
public:
   ...
   */
  bool sphereInFrustum(const Eigen::Vector3f& centre_S,
   ...
   * that the far plane is at infinity.
   */
  bool sphereInFrustumInf(const Eigen::Vector3f& centre_S,
                          const float            radius) const
  {
...
#include "se/sensor/pinhole_camera.hpp"
#include "se/sensor/ouster_lidar.hpp"

#include "se/sensor/impl/sensor_impl.hpp"
